...
public class ClienteController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<Map<String, Object>> getClienteById(@PathVariable("id") Integer id) {
        try {
            Cliente cliente = clienteService.obtenerPorId(id);
            return createResponse(Boolean.TRUE, "Perfil cargado", cliente, HttpStatus.OK);
        } catch (Exception e) {
            return createError(e);
        }
    }
